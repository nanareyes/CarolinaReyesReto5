                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <form>
                        <div class="campos-formulario form-group">
                            ...
                            <input v-model="cliente.identificacion" type="text" class="form-control" id="identificacion" name="identificacion" placeholder="Ingrese su identificación" required>
                        </div>
                        <div class="campos-formulario form-group">
                            <label>Nombres</label>
                            <input v-model="cliente.nombres" type="text" class="form-control" id="nombres" name="nombres" placeholder="Ingrese su nombre" required>
                        </div>
                        <div class="campos-formulario form-group">
